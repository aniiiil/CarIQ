...
export function TestDriveForm({ car, testDriveInfo }) {
  ...
  useEffect(() => {
    ...
    for (let hour = openHour; hour < closeHour; hour++) {
      ...
      //   if slot is not booked then slot push to slot array
      if (!isBooked) {
        slots.push({
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          ...
                          >
                            ...
                            {field.value
                              ? format(field.value, "PPP") //December 15th , 1999
                              : "Pick a date"}
                          </Button>
                        </PopoverTrigger>
            ...
            <div className="py-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{dealership?.name || "CarIQ Motors"}</span>
                </div>
              </div>
