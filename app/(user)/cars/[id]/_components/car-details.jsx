    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this ${car.year} ${car.make} ${car.model} on CarIQ!`,
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-5/12">
          <div className="flex items-center justify-between">
            <Badge className="mb-2 p-2 px-4 font-bold ">{car.bodyType}</Badge>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm sm:text-base">{car.fuelType}</span>
            </div>
            <div className="flex items-center gap-2">
              <Car className="text-gray-500 h-5 w-5" />
              <span className="text-sm sm:text-base">{car.transmission}</span>
            </div>
          </div>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>CarIQ Car Loan Calculator</DialogTitle>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">CarIQ Motors</h4>
