...
const AddCarForm = () => {
  ...
  useEffect(() => {
    if (processImageResult?.success) {
      ...
      toast.success("Successfully extracted car details", {
        description: `Detected ${carDetails.year} ${carDetails.brand} ${
          carDetails.model
  ...
  //Onclick function to process image with Gemini AI
  ...
  const onSubmit = async (data) => {
    ...
    console.log("image", uploadedImages, carData)
  }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      {...register("seats")}
                      placeholder="e.g. 5"
                      className={errors.seats ? "border-red-500 mb-2" : "mb-2"}
                    />
                    {errors.seats && (
                      <p className="text-xs text-red-500">
                          ...
                          return (
                            <div key={index} className="relative group">
                              ...
                              <Button
                                ...
                                size="icon"
                                variant="destructive"
                                className="absolute rounded-full top-1 right-1 h-6 w-6 opacity-0 group-hover:opacity-100 transition-opacity"
