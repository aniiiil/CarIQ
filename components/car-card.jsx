    ...
    <Card className=" relative overflow-hidden hover:shadow-lg transition group  py-0">
      <div className=" h-48">
        ...
        <Button
          variant="ghost"
          size="icon"
          className={`absolute right-2 top-2 bg-white/90 rounded-full p-1.5 ${
            isSaved
      ...
      <CardContent className="p-4">
        ...
        <div className="flex flex-wrap gap-1 mb-4">
          <div className="bg-gray-50 border px-2 rounded-lg">
            {car.bodyType}
          </div>
          ...
          <div className="bg-gray-50 border px-2 rounded-lg">{car.color}</div>
        </div>
