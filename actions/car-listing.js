...
export async function getCars({
  ...
  try {
    ...
    // Build where conditions for different  given filters
    if (search) {
      Where.OR = [
    ...
    // Add price range
    where.price = {
      gte: parseFloat(minPrice) || 0, //gte is greater than equal to the given min price
    }
...
//Function to toggle car in user's wishlist
...
//Function to get users-saved car
